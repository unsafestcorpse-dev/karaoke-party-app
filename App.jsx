...
const appId = typeof __app_id !== 'undefined' ? __app_id : 'karaoke-party-123';
...
const AdminView = ({ requests, loading, updateStatus, deleteRequest, clearAllRequests, setView }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 animate-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-2">
          {!showConfirm ? (
            ...
            <div className="flex items-center gap-2 bg-red-50 p-1 px-2 rounded-lg border border-red-200 animate-in fade-in zoom-in-95">
...
const LoginView = ({ handleAdminLogin, adminPass, setAdminPass, statusMsg, setView }) => (
  <div className="max-w-md mx-auto p-6 mt-12 animate-in zoom-in-95 duration-300">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-gray-900 selection:bg-purple-100 selection:text-purple-700">
